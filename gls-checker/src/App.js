...
export default function App() {
  ...
  // Lock again after the chosen inactivity period or after being away for 1 minute.
  useEffect(() => {
    ...
    const resetTimer = () => {
      ...
      inactivityTimer = setTimeout(lock, lockMinutes * 60 * 1000);
    };
...
Thank you for choosing GRACE-LED SYSTEMS!`;
  ...
  async function undoTransaction(entry) {
  ...
  const todayLabel = nowStamp().date;
          ...
          <>
            ...
            <div style={S.searchBox}>
              ...
              <input
                ...
                placeholder="Search name, phone, serial or PIN..."
                value={search}
                onChange={(e) =>
